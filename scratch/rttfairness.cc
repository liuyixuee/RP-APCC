...
int main (int argc, char *argv[]) {   
    ...
    p2p_1.SetChannelAttribute("Delay", StringValue("4ms"));
    NetDeviceContainer p2p_1_devices;
    p2p_1_devices = p2p_1.Install(remote_servers.Get(0), core_switches.Get(0));
    p2p_1.SetChannelAttribute("Delay", StringValue("39ms"));
    NetDeviceContainer p2p_1_devices_server2;
    p2p_1_devices_server2 = p2p_1.Install(remote_servers.Get(1), core_switches.Get(0));   
    ...
    address.SetBase ("192.168.203.0", "255.255.255.0");
    Ipv4InterfaceContainer p2p_1_interfaces_server2 = address.Assign(p2p_1_devices_server2);
