...
double QueueDiscItem::GetSendTime() const
{
  NS_LOG_FUNCTION (this);
  return m_sendTime;
}

void QueueDiscItem::SetSendTime(double sendTime)
{
  NS_LOG_FUNCTION (this<<sendTime);
  m_sendTime=sendTime;
}

double QueueDiscItem::GetArrivalTime() const
{
  NS_LOG_FUNCTION (this);
  return m_ackCurArrvTime;
}

void QueueDiscItem::SetArrivalTime(double arrivalTime)
{
  NS_LOG_FUNCTION (this<<arrivalTime);
  m_ackCurArrvTime=arrivalTime;
}
